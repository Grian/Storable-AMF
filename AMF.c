 ...
 * contents of AMF.xs. Do not edit this file, edit AMF.xs instead.
 *
...
XS(XS_Storable__AMF0_dclone); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF0_dclone)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF0_thaw); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF0_thaw)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF0_deparse_amf); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF0_deparse_amf)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF0_freeze); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF0_freeze)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_deparse_amf); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_deparse_amf)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_thaw); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_thaw)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_endian); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_endian)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_freeze); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_freeze)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_new_date); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_new_date)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Storable__AMF3_perl_date); /* prototype to pass -Wmissing-prototypes */
XS(XS_Storable__AMF3_perl_date)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
extern "C"
#endif
XS(boot_Storable__AMF); /* prototype to pass -Wmissing-prototypes */
XS(boot_Storable__AMF)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...

    {
        ...
        (void)newXSproto_portable("Storable::AMF0::dclone", XS_Storable__AMF0_dclone, file, "$");
        (void)newXSproto_portable("Storable::AMF0::thaw", XS_Storable__AMF0_thaw, file, "$;$");
        (void)newXSproto_portable("Storable::AMF0::deparse_amf", XS_Storable__AMF0_deparse_amf, file, "$;$");
        (void)newXSproto_portable("Storable::AMF0::freeze", XS_Storable__AMF0_freeze, file, "$");
        (void)newXSproto_portable("Storable::AMF3::deparse_amf", XS_Storable__AMF3_deparse_amf, file, "$;$");
        (void)newXSproto_portable("Storable::AMF3::thaw", XS_Storable__AMF3_thaw, file, "$;$");
        newXS("Storable::AMF3::endian", XS_Storable__AMF3_endian, file);
        (void)newXSproto_portable("Storable::AMF3::freeze", XS_Storable__AMF3_freeze, file, "$");
        cv = newXSproto_portable("Storable::AMF3::new_date", XS_Storable__AMF3_new_date, file, "$");
        XSANY.any_i32 = 0 ;
        cv = newXSproto_portable("Storable::AMF::new_date", XS_Storable__AMF3_new_date, file, "$");
        XSANY.any_i32 = 1 ;
        cv = newXSproto_portable("Storable::AMF0::new_date", XS_Storable__AMF3_new_date, file, "$");
        XSANY.any_i32 = 2 ;
        cv = newXSproto_portable("Storable::AMF3::perl_date", XS_Storable__AMF3_perl_date, file, "$");
        XSANY.any_i32 = 0 ;
        cv = newXSproto_portable("Storable::AMF::perl_date", XS_Storable__AMF3_perl_date, file, "$");
        XSANY.any_i32 = 1 ;
        cv = newXSproto_portable("Storable::AMF0::perl_date", XS_Storable__AMF3_perl_date, file, "$");
        XSANY.any_i32 = 2 ;
    }
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
